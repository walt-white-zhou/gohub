...
func UserUpdateProfie(data interface{}, c *gin.Context) map[string][]string {
	...
	messages := govalidator.MapData{
		...
		"introduction": []string{
			"min_cn:描述长度至少需要 4 个字",
			"max_cn:描述长度不能唱过 240 个字",
		},
		"city": []string{
			"min_cn:城市需至少 2 个字",
			"max_cn:城市不能超过 20 个字",
